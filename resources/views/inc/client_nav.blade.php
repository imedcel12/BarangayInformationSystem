<header class="header-blue" style="padding-bottom: 0px;">
    <nav class="navbar navbar-primary navbar-expand-md navigation-clean-search">
        <div class="container-fluid"><a class="navbar-brand" href="/barangay/home" style="font-size: 45px;font-family: bodoni mt;"><img src="{{ URL::asset('images/blogo.png')}}" style="resize: both;width: 100px;margin-right: 30px;"><p class="navbar-brand" id="client_navbar" style="font-size: 45px;">{{ $image->barangay_name ?? 'Brgy. Banlasan Information System' }}</p></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <form class="form-inline mr-auto" target="_self">
                    <div class="form-group mb-0"><label for="search-field"></label></div>
                </form>
                <p class="navbar-text" id="navbar-firstname" style="margin-top: 15px;margin-right: 11px;color: rgb(239, 239, 239);font-size: 20px;"><i class="fa fa-user" style="margin-right: 5px;"></i>{{session("resident.firstname")}}</p><span class="navbar-text"> </span>
