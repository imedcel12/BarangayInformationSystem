...
@section('content')
    ...
    <div class="container d-flex align-item-center justify-content-between pt-4">
        <div class="card" style="width: 26rem;">
            <div class="card-body">
                <h5 class="card-title text-center">Mission</h5>
                <h6 class="card-subtitle mb-2 text-muted">Card subtitle</h6>
                <p class="card-text">To deliver efficient quality and productive service to the constituents.</p>
